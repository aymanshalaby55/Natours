    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type, " successfuly Updated"));
            // send us back to home page if we logged in
          }
          _context.next = 14;
          break;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          stripe = Stripe('pk_test_51Of7M7DUHuuBmb7n6yOETtN5qs8RfrDMcVonCqdJICxX232v4j6nT2TSlyEl3IlOXV9VfFBPBym8TICoGXzV1PQV00jFFuF0DQ');
          _context.prev = 1;
          _context.next = 4;
...
},{"./login":"login.js","./updateSetting":"updateSetting.js","./stripe":"stripe.js","./alerts":"alerts.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
